...
let sidespeed = 0
let vertspeed = 0
let testright,testleft,testup,testdown
let dx,dy,hypotenuse
let timer,hittimer,guardhittimer,guardanimationtimer,guardallowedhit
let triggered = true
...
function setup() {
  ...
  s2wall2 = new Wall (275,512.5,550,295)
  ...
  s4wall1 = new Wall (400,512.5,800,295)
  s4wall2 = new Wall (625,137.5,350,295)
  s4wall3 = new Wall (225,235,800,100)
  ...
  s7wall1 = new Wall (625,512.5,350,295)
  ...
  finalKey= new Key (175,400,0.75,true,false)
...
class Dude {
    ...
    rotatedSword(this.x+15,this.y,(1/3))
    rotated=true
  }
  else{
    rotated=false
...
if(dude1.x<=340&&dude1.y<=210&&stage7==true){
  stage7=false
  stage10=true
  dude1.x=590
  dude1.y=550
...
function leaveStage9(){
  ...
  if(dude1.y>=400&&dude1.y<=500&&stage9==true&&finalKey.owned==true){
    stage9=false
    start=true
    dude1.y=4
    finished=true
...
function mouseClicked(){
  if (dude1.x>=550&&mouseX>=600&&mouseX<=700&&mouseY>=250&&mouseY<=400&&stage2==true&&buying==false){
    buying=true
    moveable=false
}
...
function keyPressed(){
  ...
  if (stage3==true&&dude1.x<=s3minotaur.x+15&&dude1.x>=s3minotaur.x-17&&dude1.y<=s3minotaur.y+27&&dude1.y>=s3minotaur.y-27&&keyIsDown(16)&&minotaur1moving==false&&allowedHit==true){
    allowedHit=false
    hittimer = frameCount
    s3minotaur.health-=attackDamage
  }
  if (stage8==true&&fightingGuard1==true&&dude1.x>=450&&dude1.x<=480&&keyIsDown(16)&&allowedHit==true){
    allowedHit=false
    hittimer = frameCount
...
function guardAttack(){
  ...
  if (rotatedAxe==false&&frameCount==guardhittimer+120){
  rotatedAxe=true
  guardanimationtimer=frameCount
}
if(frameCount>=guardanimationtimer+30){
  ...
  if(dude1.x>=420&&dude1.x<=480&&guardallowedhit==true&&frameCount>=guardhittimer+120){
